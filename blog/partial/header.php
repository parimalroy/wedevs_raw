...
<head>
    ...
    <title>Blogify - <?php echo $title ?></title>
...
<header class="bg-slate-800 text-white shadow-lg">
    <div class="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav id="menu" class="hidden md:flex space-x-6">
            ...
            <a href="../blog/" class="hover:underline text-slate-300 px-4 py-2 rounded-md <?php echo urls("/wedevs_raw/blog/")?'bg-slate-700 font-bold text-white':''; ?>">Home</a>

            <a href="../blog/list.php" class="hover:underline text-slate-300 px-4 py-2 rounded-md <?php echo urls("/wedevs_raw/blog/list.php")?'bg-slate-700 font-bold text-white':''; ?>">List</a>
            
            <a href="../blog/details.php" class="hover:underline text-slate-300 px-4 py-2 rounded-md <?php echo urls("/wedevs_raw/blog/details.php")?'bg-slate-700 font-bold text-white':''; ?>">Details</a>
        </nav>
    </div>
